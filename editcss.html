...
<body >
  <a href="daftarmenu.html"style="text-decoration : none; color:#a69890; ">
  ...
  <i class="bi bi-arrow-right-short"></i>
   ...
   <form action="/products/update/{{ $product->id }}" method="POST">
    ...
    <h2 class="judul">Edit Product</h2>
  <div class="mb-3">
    ...
    <input type="number" name="harga" value="{{ $product->harga }}" class="form-control">
      ...
      <label class="form-label" style="margin-top:15px">Deskripsi: </label>
          <textarea class="form-control" rows="3" type="text" name="deskripsi" value="{{ $product->deskripsi }}"></textarea>
